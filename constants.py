...
SECTORS = {
    ...
    'Consumer Cyclical': ['AMZN','TSLA','BABA','TM','MCD','PDD','TJX','MELI','SBUX','SE','ORLY','CVNA','RACE','AZO','CPNG','CMG','GM','ROST','JD','F','FLUT','CPRT','EBAY','YUM','CCL','CUK','LVS','STLA','TSCO','IP','ULTA','WSM','LI','QSR','DRI','SW','CASY','XPEV','RL','LULU','AMCR','GPC','PKG','APTV','BURL','AS','DKNG','BBY','YUMC','RIVN','CHWY','HMC','NIO','DPZ','ONON','SN','BALL','MGA','WYNN','TXRH','MBLY','PAG','CCK','W','HAS','GME','CART','VIPS','BWA','GIL','ALV','BROS','FIVE','LEVI','AN','MOD','GAP','LAD','MHK','PLNT','LKQ','VFS','MUSA','ZK','CAVA','WING','ETSY','MNSO','ALSN','BYD','KMX','SGHC','LNW','CHDN','LCID','URBN','MAT'], #
    ...
    'Consumer Defensive': ['PG','UL','CL','KMB','EL','KHC','KVUE','JBS','GIS','CHD','MKC','SGI','CLX','HRL','SJM','HIMS','EDU','CPB','LW','CAG','PPC','INGR','ELF','TAL','LRN','LOPE','POST','ATGE','DAR','MZTI','LAUR','GHC','BRBR','COTY','IPAR','FLO','FRPT','SMPL','MH','PRDO','NWL','STRA','NOMD','JJSF','CENTA','CENT','UTI','COUR','AFYA','SPB','DAO','PXED','GOTU','UTZ','UDMY','THS','EPC','HLF','SENEA','SENEB','JBSS','KLC','LINC','STKL','APEI','NUS','WEST','HELE','LWAY','VSTA','MAMA','USNA','QSG','BGS','BRCC','ABVE','SLSN','NATR','PTNM','EWCZ','SKIN','FTLF','ACU','SKIL','CHGG','YOUL','LGCY','HAIN','VSA','LFVN','LFS','STG','GNS','BRLS','BIRD','DDC','GROV','ATPC','COOT','WYHG'], #
    'Communication Services': ['GOOG','GOOGL','META','NFLX','TMUS','DIS','T','VZ','SPOT','DASH','CMCSA','AMX','WBD','BIDU','RDDT','LYV','CHTR','FWONA','TME','FWONK','CHT','NBIS','VOD','TEF','FOXA','FOX','TU','BCE','PINS','RCI','VIV','TLK','Z','WMG','TWLO','ZG','TKO','NWS','OMC','NWSA','ROKU','SNAP','PSKY','TIMB','IPG','FYBR','KT','LLYVK','LBRDK','LBRDA','SKM','LLYVA','TIGO','MTCH','SIRI','LUMN','NXST','GSAT','MSGS','WPP','TKC','DJT','AD','TDS','PHI','LBTYK','LBTYA','VEON','LBTYB','TEO','KYIV','MANU','JOYY','CNK','GENI','WB','IAC','MGNI','BATRA','BATRK','IHS','CCOI','SPHR','MSGE','YELP','DOYU','IRDM','IQ','LION','IMAX','IAS','NN','LILAK','LILA','CMPR','ZD','OPRA','AMC','GIBO','STGW'], #
