...
if __name__ == "__main__":
    ...
    TOP_500_BASE = ALL_TICKERS_SORTED_BY_MC[:500]
    INDEX_TICKERS = list(INDEX_TICKER_TO_NAME.keys())
    # Use set to ensure uniqueness when combining
    TICKERS_FOR_JOB_2_3 = list(set(TOP_500_BASE + INDEX_TICKERS))
    ...
    with server.app_context():
        ...
        try:
            ...
            update_daily_prices(days_back=5*365, tickers_list_override=TICKERS_FOR_JOB_2_3) # <<< ใช้ List ที่จำกัด
